...
3. STOP â€” these two steps run on my desktop app and you cannot do them for me:
...
5. This is licensed software â€” point me at LICENSE and docs/licensing.md and note the
   FREE / PRO / ENTERPRISE tiers. Never invent, commit, or share licence keys.
```

## What's Included

- `plugin/` â€” CATIA Magic plugin JAR (copy to your plugins directory)
- `server/` â€” Python MCP server (install with `pip install ./server`)
- `docs/` â€” Installation guide and configuration reference
- `tools/` â€” Licence verification utility
- `examples/` â€” Sample `.mcp.json` configuration
...
Proprietary â€” see [LICENSE](LICENSE) and [docs/licensing.md](docs/licensing.md).
